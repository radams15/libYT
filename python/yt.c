...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__yt

#else
#  define SWIG_init    init_yt

#endif
#define SWIG_name    "_yt"
...
SWIGINTERN PyObject *_wrap_Channel_id_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (arg2) {
    ...
    arg1->id = (char *)(char *)memcpy(malloc((size)*sizeof(char)), (const char *)(arg2), sizeof(char)*(size));
  } else {
    arg1->id = 0;
  }
...
SWIGINTERN PyObject *_wrap_channel_new(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
...
SWIGINTERN PyObject *_wrap_channel_get_vids(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg2 = (struct Config *)(argp2);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "channel_get_vids" "', argument " "3"" of type '" "vid_cb""'"); 
    }
  }
  res4 = SWIG_ConvertPtr(swig_obj[3],SWIG_as_voidptrptr(&arg4), 0, 0);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "channel_get_vids" "', argument " "4"" of type '" "void *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_Config_invidious_inst_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (arg2) {
    size_t size = strlen((const char *)((const char *)(arg2))) + 1;
    arg1->invidious_inst = (char const *)(char *)memcpy(malloc((size)*sizeof(char)), arg2, sizeof(char)*(size));
  } else {
...
SWIGINTERN PyObject *_wrap_config_get_vids(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (struct Config *)(argp1);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "config_get_vids" "', argument " "2"" of type '" "vid_cb""'"); 
    }
  }
  res3 = SWIG_ConvertPtr(swig_obj[2],SWIG_as_voidptrptr(&arg3), 0, 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "config_get_vids" "', argument " "3"" of type '" "void *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_Video_title_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (arg2) {
    size_t size = strlen((const char *)(arg2)) + 1;
    arg1->title = (char *)(char *)memcpy(malloc((size)*sizeof(char)), (const char *)(arg2), sizeof(char)*(size));
  } else {
    arg1->title = 0;
  }
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_Video_channel_name_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (arg2) {
    size_t size = strlen((const char *)(arg2)) + 1;
    arg1->channel_name = (char *)(char *)memcpy(malloc((size)*sizeof(char)), (const char *)(arg2), sizeof(char)*(size));
  } else {
    arg1->channel_name = 0;
  }
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_Video_channel_id_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (arg2) {
    size_t size = strlen((const char *)(arg2)) + 1;
    arg1->channel_id = (char *)(char *)memcpy(malloc((size)*sizeof(char)), (const char *)(arg2), sizeof(char)*(size));
  } else {
    arg1->channel_id = 0;
  }
  resultobj = SWIG_Py_Void();
